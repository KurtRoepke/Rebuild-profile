...
<h2>Description</h2>
This repository explain's the process of rebuilding a corrupted windows profile and transffering important files to the new profile.I use the file explorer to find the user profile and, rename it. Next we access the windows registry to delete the user key so windows can rebuid the profile and, finally transfer important files by going to Users in the file explorer.
<br />
